...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        bio: value.bio,
        latitude: value.latitude !== undefined && value.latitude !== null ? candid_some(value.latitude) : candid_none(),
        name: value.name,
        ...
        district: value.district,
        experience: value.experience,
        longitude: value.longitude !== undefined && value.longitude !== null ? candid_some(value.longitude) : candid_none(),
        village: value.village,
        mandal: value.mandal,
        phone: value.phone,
        pincode: value.pincode
